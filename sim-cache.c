//CS572 Spring 2018
//Computer Architecture Bonus Points
//Implementation of Level 3 caches
//
//Dongkyu Kim
//933-296-408

//Search "L3" to find changed locations
...
static struct cache_t *cache_il3 = NULL; // L3 Added
...
/* level 3 data cache */
static struct cache_t *cache_dl3 = NULL; // L3 Added
...
#define MAX_PCSTAT_VARS 10 // L3 Modified: Increased from 8 to 10.
...
dl2_access_fn(enum mem_cmd cmd,         /* access cmd, Read or Write */
              ...
              tick_t now)               /* time of access */
{
    // L3 Modified (BEGIN): Redirect to level 3 cache if it exists.
    if (cache_dl3)
    {
        /* access next level of data cache hierarchy */
...
// L3 Added (BEGIN): Level 3 data-cache handler function
...
// L3 Added (BEGIN): Level 3 instruction-cache handler function.
...
static char *cache_dl3_opt /* = "none" */; // L3 Added
static char *cache_il1_opt /* = "none" */;
static char *cache_il2_opt /* = "none" */;
static char *cache_il3_opt /* = "none" */; // L3 Added
...
sim_reg_options(struct opt_odb_t *odb)  /* options database */
{
    ...
    opt_reg_string(odb, "-cache:dl3",
                   ...
                   &cache_dl3_opt, "ul3:1024:64:4:l", /* print */TRUE, NULL); // L3 Added
    ...
    opt_reg_string(odb, "-cache:il3",
                   ...
                   &cache_il3_opt, "dl3", /* print */TRUE, NULL); // L3 Added
                  ...
                  int argc, char **argv)        /* command line arguments */
{
    ...
    else /* dl1 is defined */
    {
        ...
        else
        {
            ...
            // L3 Added (BEGIN): Level 3 data cache creation.
    ...
    else if (!mystricmp(cache_il1_opt, "dl2"))
    {
        ...
        // L3 Added (BEGIN): Link instruction level 1 with data level 3 cache.
    ...
    else /* il1 is defined */
    {
        ...
        else if (!mystricmp(cache_il2_opt, "dl2"))
        {
            ...
            // L3 Added (BEGIN): Link instruction level 2 with data level 3 cache.
        ...
        else
        {
            ...
            // L3 Added (BEGIN): Level 3 instruction cache creation.
...
sim_reg_stats(struct stat_sdb_t *sdb)   /* stats database */
{
    ...
    // L3 Modified (BEGIN): Register the new caches.
    if (cache_il1
